...
export default function Dashboard() {
    ...
    const [activeTab, setActiveTab] = useState<ModelType>("U-Net PRO (M2)");
    ...
    const currentResultImage = activeTab === "U-Net PRO (M2)" ? results.unet : results.pix2pix;
                    ...
                    <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
                        ...
                        <ul className="space-y-3 text-sm">
                            <li className="flex justify-between items-center">
                                ...
                                <span className="font-semibold text-[#00539C] bg-blue-50 px-2 py-1 rounded transition-all">
                                    {activeTab}
                                </span>
                            </li>
                            <li className="flex justify-between items-center">
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden flex flex-col">
                        ...
                        <div className="bg-[#00539C] px-3 pt-3 flex justify-between items-end border-b-2 border-[#004380]">
                            <div className="flex items-end gap-1">
                                <button
                                    onClick={() => setActiveTab("U-Net PRO (M2)")}
                                    className={`px-5 py-2.5 text-sm font-bold tracking-wide rounded-t-lg transition-colors ${
                                        activeTab === "U-Net PRO (M2)"
                                            ? "bg-white text-[#00539C]"
                                            : "bg-[#004380] text-blue-200 hover:bg-[#003B70]"
                                    }`}
                                >
                                    U-Net PRO
                                </button>
                                <button
                                    onClick={() => setActiveTab("Pix2Pix (M1)")}
                                    className={`px-5 py-2.5 text-sm font-bold tracking-wide rounded-t-lg transition-colors ${
                                        activeTab === "Pix2Pix (M1)"
                                            ? "bg-white text-[#00539C]"
                                            : "bg-[#004380] text-blue-200 hover:bg-[#003B70]"
                                    }`}
                                >
